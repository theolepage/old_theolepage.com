...
<div class="resume">
    ...
    <div class="resume-header">
        <div class="resume-head">
            ...
            <div class="resume-description">Looking for an internship in Software Engineering starting in September 2020.</div>
        </div>
    ...
    <div class="resume-section resume-education">
        <div class="resume-dot resume-dot_green"></div>
        <div class="resume-title">Education</div>
    
        <div class="resume-item">
            <div class="resume-subtitle">
                <a href="https://www.lse.epita.fr/">LSE - Laboratoire Sécurité & Système de l'EPITA</a>
                (Research laboratory)
            </div>
            ...
            <div class="resume-text">Student Researcher in machine learning. Currently working on a prototype of a self-driving car.</div>
        </div>
        ...
        <div class="resume-item">
            ...
            <div class="resume-text">Master in Computer Science. First three years taught in English (international section).</div>
        </div>

        <div class="resume-item">
            <div class="resume-subtitle">
                <a href="https://www.epita.fr/en">CSUMB - California State University, Monterey Bay</a>
                (Semester abroad)
            </div>
            <div class="resume-icons">
                <div class="resume-location">
            ...
            <!-- <div class="resume-text">Worked on a startup project after participating to a Techstars Startup Weekend.</div> -->
        </div>
    </div>

    <div class="resume-section resume-section_experience">
        <div class="resume-dot resume-dot_red"></div>
        ...
        <div class="resume-experience">
            <div class="resume-experience-content">
                <div class="resume-experience-header">
                    <div class="resume-subtitle">
                        Teaching Assistant at <a href="https://www.epita.fr/en">EPITA</a>
                    </div>
    ...
    <div class="resume-section resume-projects">
        <div class="resume-dot resume-dot_blue"></div>
        ...
        <div class="resume-cols">
            ...
            <div class="resume-col">
                <div class="resume-item">
                    <div class="resume-subtitle">
                        <a href="https://thdoteo.com">A POSIX shell: 42sh</a>
                    </div>
                    <div class="resume-text">Implemented a shell in 4 weeks in C by following the Command Shell Language standard.</div>
                </div>

                <div class="resume-item">
                    <div class="resume-subtitle">
                        <a href="https://thdoteo.com">My website: thdoteo.com</a>
                    </div>
    ...
    <div class="resume-section resume-interests-skills">
        <div class="resume-dot resume-dot_orange"></div>
    ...
    <div class="resume-footer">
        An interactive and up-to-date version of this document is available at <a href="https://theolepage.com/resume">theolepage.com/resume</a>.
    </div>
