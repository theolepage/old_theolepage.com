<?php $__env->startSection('title', 'CV — Theo Lepage'); ?>
...
<div class="resume">
    ...
    <div class="resume-header">
        ...
        <div class="resume-header-content">
            ...
            <div class="resume-description">Recherche un stage en Développement Logiciel ou en Machine Learning<br /> à partir de Septembre 2020.</div>
    ...
    <div class="resume-section resume-section_experience">
        <div class="resume-title">Expérience professionnelle</div>

        <div class="resume-experience">
            <div class="resume-experience-content">
                <div class="resume-experience-header">
                    <div class="resume-subtitle">
                        <span class="resume-emphasize">Assistant chercheur en Machine Learning</span> au <a href="https://www.lse.epita.fr/">LSE</a>
                    </div>
                ...
                <div class="resume-text">
                    Réalisation d'un prototype de voiture autonome pour participer au <a href="https://www.roboracingleague.com/">DIY Robocars</a> français chaque mois.<br />
                    Lecture et mise en œuvre de nouvelles méthodes et articles dans le domaine de l'intelligence artificielle.
                </div>
            </div>
        ...
        <div class="resume-experience">
            <div class="resume-experience-content">
                <div class="resume-experience-header">
                    <div class="resume-subtitle">
                    <span class="resume-emphasize">Assistant enseignant</span> à <a href="https://www.epita.fr/en">EPITA</a>
                    </div>
                    <div class="resume-experience-icons">
                        <div class="resume-location">
                            <img class="resume-icon" src="/images/icon-map.svg" alt="icon-map">
                ...
                <div class="resume-text">
                    Enseignement du C aux étudiants de deuxième année grâce à des travaux pratiques notés chaque semaine.<br />
                    Développement d'une app permettant à d'autres assistants de tester et de noter les projets des étudiants.
                </div>
            </div>
            <div class="resume-experience-image">
    ...
    <div class="resume-section resume-education">
        <div class="resume-title">Formation</div>
        ...
        <div class="resume-item">
            ...
            <div class="resume-text">
                Développement d'un profond intérêt pour l'informatique à travers divers projets stimulants en petits groupes.<br />
                Trois premières années enseignées en anglais en tant qu'étudiant de la section internationale.<br />
                Cours : Algèbre linéaire, Programmation, Architecture / réseaux informatiques, Probabilités, Statistiques, ...
            </div>
        </div>
        ...
        <div class="resume-item">
            ...
            <div class="resume-text">
                Cours : Mathématiques discrètes, Développement logiciel, Programmation graphique, Réseaux informatiques.<br />
                Participation à un Techstars Startup Weekend et création d'une app "matchant" l'utilisateur à des prestataires de santé.
            </div>
        </div>
    </div>

    <div class="resume-section resume-projects">
        <div class="resume-title">Projets</div>
            ...
            <div class="resume-col">
                <div class="resume-item">
                    <div class="resume-subtitle resume-emphasize">
                        ...
                        <a href="/lab/prophecy">Prophecy - un framework de neural networks</a>
                    </div>
                    <div class="resume-text">
                        Implémentation de tableaux à n dimensions, dense et convolution en C++ et Cuda. Le projet offre certaines fonctionnalités de Keras et gère le dataset MNIST.
                    </div>
                </div>
    ...
    <div class="resume-section resume-interests-skills">
        <div class="resume-title">Intérêts et compétences</div>

        <div class="resume-cols">
            <div class="resume-col">
                <div class="resume-item">
                    <div class="resume-subsubtitle">Langages de programmation / technologies</div>
                ...
                <div class="resume-item">
                    <div class="resume-subsubtitle">Divers</div>
                    <div class="resume-label">Algorithmes</div>
                    <div class="resume-label">Machine Learning</div>
                    <div class="resume-label">Développement Logiciel</div>
                    <div class="resume-label">Gestion de projet</div>
            ...
            <div class="resume-col">
                <div class="resume-item">
                    <div class="resume-subsubtitle">Certificats</div>
                    <div class="resume-label">Permis de conduire</div>
                    <div class="resume-label">Diplôme de moniteur de voile</div>
                </div>

                <div class="resume-item resume-floating">
                    <div class="resume-subsubtitle">Langages</div>
                    <div class="resume-label">Anglais (TOEIC 905)</div>
                    <div class="resume-label">Français</div>
                </div>

                <div class="resume-item">
                    <div class="resume-subsubtitle">Passions et intérêts</div>
    ...
    <div class="resume-footer">
        Une version à jour de ce document est disponible à l'adresse <a href="/resume/fr">theolepage.com/resume/fr</a> (<a href="/resume">en anglais</a>).
    </div>
