        ...
        <div class="lab-section">
            ...
            <div class="lab-spec">
                ...
                <div class="lab-spec-value">
                    <div class="lab-color" style="background: <?php echo e($project->getColor()); ?>;"></div>
                    <?php echo e($project->getColor()); ?>
                ...
                <div class="lab-spec-value">
                    ...
                    <?php else: ?>
                        <div class="lab-progress">
                            <div class="lab-progress-bar" style="width: <?php echo e($project->progress); ?>%"></div>
                            <div class="lab-progress-value"><?php echo e($project->progress); ?>%</div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="lab-spec">
                ...
                <div class="lab-spec-value">
                    <div class="lab-checkbox">
                        <?php if(!empty($project->github_repo_name)): ?>  <img class="lab-checkbox-mark" src="/images/icon-check.svg" alt="icon-check"> <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="lab-spec">
