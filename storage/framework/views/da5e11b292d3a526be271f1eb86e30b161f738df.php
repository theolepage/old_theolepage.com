...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-nav">
            ...
            <?php else: ?>
                <a href="/" class="header-nav-main <?php if(Route::currentRouteName() === 'projects.index'): ?> header-nav-main_active <?php endif; ?>">Laboratory</a>
                <a href="/about" class="header-nav-item <?php if(Route::currentRouteName() === 'about'): ?> header-nav-item_active <?php endif; ?>">About</a>
                <a href="/contact" class="header-nav-item <?php if(Route::currentRouteName() === 'contact'): ?> header-nav-item_active <?php endif; ?>">Contact</a>
            <?php endif; ?>
        </div>
    </div>
